...
with open("../data/n-bigram/n2_bigram_score.csv") as f:
    reader = csv.DictReader(f)
    for row in reader:
        n2_bigram_score[row["key"]] = float(row["value"])
...
best_score = 2.5 # isrt is 2.88, ive gotten as low as 1.66 in testing, just to speed stuff up lol
min_cap = 0.4
best_g1 = ""
best_g2 = ""
best_g3 = ""
                ...
                for g5 in n3_bigram_score:
                    ...
                    for g6 in n2_bigram_score:
                        ...
                        for g7 in n2_bigram_score:
                            ...
                            g7_score = n2_bigram_score[g7]
                            if g7_score > min_cap or g7_score > best_score:
                                continue
                            
                            score = g1_score + g2_score + g3_score + g4_score + g5_score + g6_score + g7_score
                            if score < best_score:
                                best_score = score
                                best_g1 = g1
                                best_g2 = g2
                                ...
                                print(f"{best_g1} {best_g2} {best_g3} {best_g4} {best_g5} {best_g6} {best_g7}")
